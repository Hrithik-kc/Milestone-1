  ...
  return (
    <div className="bg-white">
      <div className="h-[40%] w-[100%] bg-gray-500 rounded-[10px] flex flex-row">
        <div className="text-white font-bold text-[20px] pl-10 pt-3">
          envato
        </div>
        <button className=" bg-lime-500 font-bold text-[15px] text-white w-25 h-10 rounded-[10px] mt-2 mb-2 ml-310 hover:bg-lime-600">
          Buy
        </button>
      </div>
      ...
      <div className="h-[100%] w-[90%] bg-[#1C1C1C] grid grid-cols-4  ml-15">
        ...
        <div className=" ml-10 mt-20 border-r-2 border-gray-600 pr-10 mb-20">
          ...
          <div className="text-white text-[17px] mt-5">
        ...
        {/* explore */}
        <div>
          <div className="font-bold text-[30px] text-white ml-20 mt-20 mb-10 flex flex-col">
            Explore
          </div>
          <div className="text-white text-[17px] ml-20 mb-5 -mt-5 cursor-pointer hover:text-yellow-400">
            Company Profile
          </div>
          <div className="text-white text-[17px] ml-20 mb-5 cursor-pointer hover:text-yellow-400">
            About{" "}
          </div>
          <div className="text-white text-[17px] ml-20 mb-5 cursor-pointer hover:text-yellow-400">
            Help Center
        ...
        {/*Contact info*/}
        <div>
          <div className="font-bold text-[30px] text-white ml-0 mt-20 mb-10 flex flex-col">
            Contact Info
          </div>
          <div className="text-white text-[17px] mb-5 -mt-5 w-70">
            1234 - Bandit Tringi St, Sonipat, Haryana
          </div>
          <div className="text-white text-[17px] mb-5">
            Phone: +91 1234567890
          </div>
          <div className="text-white text-[17px] mb-5">
        ...
        {/* Newsletter */}
        <div>
          <div className="font-bold text-[30px] text-white  mt-20 mb-10 flex flex-col">
            Newsletter
          </div>
          <div className="text-white text-[17px]  mb-5 -mt-5 cursor-pointer hover:text-yellow-400">
            Join our subscribers list to get the latest news and special offers.{" "}
          </div>
          <input
            type="email"
            placeholder="Your Email Address"
            className="w-60 h-10 mt-5 -ml-5 rounded-[5px] pl-2 border-b-1 border-b-gray-300 text-[16px]"
          ></input>
        </div>
      </div>
      {/* register footer */}
      <div className="h-100 w-[100%] bg-gray-400 flex flex-row"></div>
    </div>
  );
}
