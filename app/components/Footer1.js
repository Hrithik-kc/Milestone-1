    ...
    <div className="dark:bg-white">
      ...
      <div className=" absolute h-270 md:h-[80%] w-full md:w-[90%] bg-[#1C1C1C] grid grid-rows-4 md:grid-cols-4  md:ml-15 dark:bg-gradient-to-r from-[#D4D4D4] to-[#909090]">
        ...
        <div className="-ml-10 md:ml-0">
          <div className="font-bold text-[30px] text-white ml-20 mt-10 md:mt-20 mb-10 flex flex-col dark:text-black">
            Explore
          </div>
          <div className="text-white text-[17px] ml-20 mb-5 -mt-5 cursor-pointer hover:text-yellow-400 dark:text-black">
            Company Profile
          </div>
          <div className="text-white text-[17px] ml-20 mb-5 cursor-pointer hover:text-yellow-400 dark:text-black">
            About{" "}
          </div>
          <div className="text-white text-[17px] ml-20 mb-5 cursor-pointer hover:text-yellow-400 dark:text-black">
            Help Center
        ...
        {/*Contact info*/}
        <div className="ml-10 md:ml-0">
          <div className="font-bold text-[30px] text-white ml-0 mt-20 mb-10 flex flex-col dark:text-black">
            Contact Info
          </div>
          <div className="text-white text-[17px] mb-5 -mt-5 w-70 dark:text-black">
            1234 - Bandit Tringi St, Sonipat, Haryana
          </div>
          <div className="text-white text-[17px] mb-5 dark:text-black">
            Phone: +91 1234567890
          </div>
          <div className="text-white text-[17px] mb-5 dark:text-black">
        ...
        {/* Newsletter */}
        <div className="ml-10 md:ml-0">
          <div className="font-bold text-[30px] text-white  mt-20 mb-10 flex flex-col dark:text-black">
            Newsletter
          </div>
          <div className="text-white text-[17px]  mb-5 -mt-5 mr-5 dark:text-black">
            Join our subscribers list to get the latest news and special offers.{" "}
          </div>
          <input
            type="email"
            placeholder="Your Email Address"
            className="text-white mb-5 md:mb-0 w-60 h-10 -mt-10 md:mt-5 ml-5 md:-ml-5 rounded-[5px] pl-2 border-b-1 border-b-gray-300 text-[16px] dark:text-black "
          ></input>
          <svg
            ...
            class=" cursor-pointer lucide lucide-chevron-right-icon lucide-chevron-right ml-65 md:ml-55 -mt-15 md:-mt-10 text-white"
          >
            <path d="m9 18 6-6-6-6" />
          </svg>
        </div>
      </div>
      <div className="block md:hidden  absolute mt-270 h-40 md:h-80 w-[100%] md:w-[100%] bg-[#121818] flex flex-row">
        <img
          src="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fshape%2F9.png&w=640&q=75"
          className="hidden md:block mt-10 h-70 w-40"
        ></img>
        <img
          src="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Flogo-light.png&w=750&q=75"
          className="h-20 w-30 mt-10 ml-40"
        ></img>
      </div>
    </div>
  );
