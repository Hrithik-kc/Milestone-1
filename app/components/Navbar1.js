    ...
    <div className="w-screen md:w-screen">
      <div className=" w-[100%] md:w-[100%]">
        ...
        <div className=" flex flex-row h-10 md:h-15 w-[100%] bg-gradient-to-r from-[#8E5E2B] via-[#D4A96F] to-[#8E5E2B] flex flex-row">
          <div className="text-white  text-[12px] md:text-[17px] ml-3 pt-1 md:ml-10  md:pt-4 flex flex-row">
            ...
            <div className="hidden md:block pl-3">Phone: 123456789</div>
          </div>
          ...
          <div className="hidden md:block text-white text-[12px] md:text-[17px] md:ml-2 pt-3 md:pt-4 ">
            food@restan.com
          </div>
      ...
      <div className="h-[50%] w-full md:w-[100%] ">
        <img
          ...
          alt="image"
          className="h-70 md:h-120 w-200 md:w-[100%]"
        />
                ...
                <ul className="flex flex-row">
                  <li>
                    <div
                      ...
                      } absolute rounded-[10px] inset-shadow-sm bg-gradient-to-r from-[#DBDED9] to-[#77512A] w-40 h-50 ml-52 mt-5 motion-safe:animate-[wiggle_1s_ease-in-out_infinite] `}
                    >
                      <div className="mt-5 ml-5  ">
                        ...
                        >
                          <a
                            herf="#"
                            className=" text-[18px] text-black font-serif font-semibold "
                          >
                            About us
                          </a>
                        </div>
                        <div
                          className="mt-5 cursor-pointer transiton delay-50 duration-300 ease-in-out hover:scale-110"
