...
export default function Navbar1() {
  ...
  return (
    <div className="static ]">
      <div className="w-[100%]">
        <div className="  h-[40%] w-[100%] bg-gray-900 flex flex-row">
          <div className="text-amber-600 font-bold text-[20px] pl-10 pt-3 sm:block">
            Sahyadri
          </div>
          <div className="mt-3 ml-1 text-[20px] text-amber-600">Cafe</div>
          <button className="md:flex flex-auto md:bg-[#597A2E] font-bold text-[15px] text-white w-15 h-8  mt-2 mb-2 mr-10 ml-260 hover:bg-[#76AE11] pt-1 pl-9.5 ">
            Buy
          </button>
        </div>
        {/* socials */}
        <div className="flex flex-row md:h-15 w-[100%] bg-gradient-to-r from-[#8E5E2B] via-[#D4A96F] to-[#8E5E2B] flex flex-row">
          <div className="text-white  text-[17px] ml-10 pt-4 flex flex-row">
            <svg
              ...
              className="lucide lucide-phone-call-icon lucide-phone-call mt-1  "
            >
              <path d="M13 2a9 9 0 0 1 9 9" />
              <path d="M13 6a5 5 0 0 1 5 5" />
              <path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384" />
            </svg>
            <div className="pl-3">Phone: 123456789</div>
          </div>
          ...
          <div className="text-white text-[17px] ml-2 pt-4">
            food@restan.com
          </div>
          ...
          <div className="flex flex-row-reverse mr-10 pt-2.5">
            <div className="">
              ...
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-languages-icon lucide-languages -ml-6 -mt-8"
              >
                <path d="m5 8 6 6" />
          ...
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="lucide lucide-facebook-icon lucide-facebook ml-10 mt-3"
          >
          ...
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="lucide lucide-instagram-icon lucide-instagram ml-4 mt-3"
          >
          ...
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="lucide lucide-twitter-icon lucide-twitter ml-4 mt-3"
          >
          ...
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="lucide lucide-youtube-icon lucide-youtube ml-4 mt-3"
          >
      ...
      <div className="h-[50%] w-[100%] ">
              ...
              {TogglePages && (
                <ul className="flex flex-row">
                  <li>
                    <div
                      className={`${
                        TogglePages ? "block" : "hidden"
                      } absolute rounded-[10px] inset-shadow-sm bg-gradient-to-r from-[#DBDED9] to-[#77512A] w-60 h-50 -ml-25 mt-10 motion-safe:animate-[wiggle_1s_ease-in-out_infinite] `}
                    >
                      <div className="mt-5 ml-5  ">
                        <div
                          className="cursor-pointer transiton delay-50 duration-300 ease-in-out hover:scale-110"
                          onClick={() => router.push("")}
                        >
                          <a
                            herf="#"
                            className=" text-[25px] text-black font-serif font-semibold "
                          >
                            About us
                          </a>
                        </div>
                        <div
                          className=" mt-2 cursor-pointer transiton delay-50 duration-300 ease-in-out hover:scale-110"
                ...
                <ul className="flex flex-row">
                  <li>
                    <div
                      ...
                      } absolute rounded-[10px] inset-shadow-sm bg-gradient-to-r from-[#DBDED9] to-[#77512A] w-60 h-50 ml-7 mt-10 motion-safe:animate-[wiggle_1s_ease-in-out_infinite] `}
                    >
                      <div className="mt-5 ml-5  ">
                        <div
                          className="cursor-pointer transiton delay-50 duration-300 ease-in-out hover:scale-110"
        ...
        <div className="absolute  top-120 left-140 font-semibold font-serif text-white text-[50px] flex justify-center items-center "></div>
      </div>
    </div>
  );
}
