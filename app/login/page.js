  ...
  return  <div className ="bg-white">
          ...
          <div className = "h-250 md:h-[80%] w-110 md:w-[83%] shadow-xl/20 rounded-[5px] bg-white md:ml-30 mt-10 mb-10 flex flex-col md:flex-row">
              ...
              <div className = "flex flex-col ">
                <div className = "font-serif text-[30px] pl-5 md:pl-20 pt-15 md:pt-5 text-[#AA6C39] font-medium">WELCOME BACK</div>
                ...
                <div className = "flex flex-col md:flex-row">
                  <div className ="text-gray-500 text-[17px] ml-27 md:ml-20 md:w-70 mt-6">Dont have an account?</div>
                  <div onClick={()=> router.push("../register")}
                  className ="text-[#B8860B] text-[17px] ml-34 md:-ml-25 mt-3 md:mt-5.5 underline cursor-pointer">Regsiter here</div>
                </div>
              </div>
          </div>
          {/*register bottom*/}
