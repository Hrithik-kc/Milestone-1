    ...
    return <div className = "dark:bg-white">
            <div className = " hidden md:block absolute mt-90 h-150 md:h-80 w-full md:w-[100%] bg-[#121818] flex flex-row">
              ...
              <div className = "-ml-10 md:ml-0">
                <div className = "font-bold text-[30px] text-white ml-20 mt-10 md:mt-20 mb-10 flex flex-col dark:text-black">Explore</div>
            ...
            <div className = "ml-10 md:ml-0">
                ...
                <input type = "email" placeholder="Your Email Address" className = "text-white mb-5 md:mb-0 w-60 h-10 -mt-10 md:mt-5 ml-5 md:-ml-5 rounded-[5px] pl-2 border-b-1 border-b-gray-300 text-[16px] dark:text-black ">
                </input>
                <svg 
                xmlns="http://www.w3.org/2000/svg"
                 ...
                 height="30"
                  viewBox="0 0 24 24"
                   fill="none" 
                   stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class=" cursor-pointer lucide lucide-chevron-right-icon lucide-chevron-right ml-65 md:ml-55 -mt-15 md:-mt-10 text-white"><path d="m9 18 6-6-6-6"/></svg>
            </div>
            </div>
